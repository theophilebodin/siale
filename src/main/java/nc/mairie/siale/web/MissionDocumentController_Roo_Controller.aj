...
import nc.mairie.siale.web.MissionDocumentController;
...
privileged aspect MissionDocumentController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String MissionDocumentController.create(@Valid MissionDocument missionDocument, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String MissionDocumentController.createForm(Model uiModel) {
        populateEditForm(uiModel, new MissionDocument());
        return "missiondocuments/create";
    }
    
    @RequestMapping(value = "/{id}", produces = "text/html")
    public String MissionDocumentController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String MissionDocumentController.update(@Valid MissionDocument missionDocument, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, missionDocument);
    ...
    public String MissionDocumentController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, MissionDocument.findMissionDocument(id));
        return "missiondocuments/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String MissionDocumentController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void MissionDocumentController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void MissionDocumentController.populateEditForm(Model uiModel, MissionDocument missionDocument) {
    ...
    String MissionDocumentController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
