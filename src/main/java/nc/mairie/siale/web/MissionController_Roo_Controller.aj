...
privileged aspect MissionController_Roo_Controller {
    ...
    public String MissionController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String MissionController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
    ...
    public String MissionController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Mission.findMission(id));
        return "missions/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String MissionController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void MissionController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void MissionController.populateEditForm(Model uiModel, Mission mission) {
